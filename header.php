          ...
          <?php
                if( has_nav_menu( 'secondary' ) ) {
                    wp_nav_menu( [
                        ...
                        'fallback_cb'           => false,
                        'depth'                 => 1,
                        //'walker'                => New JF_Custom_Nav_Walker()
                    ] );
                }
            ?>
          </div><!-- .top-links end -->
            ...
            <ul>
                <?php
                  ...
                  if( get_theme_mod( 'jf_facebook_handle' ) ) {
                    ?>
                     <li>
                      <a href="https://www.facebook.com/<?php echo get_theme_mod( 'jf_facebook_handle' ); ?>" class="si-facebook">
                  ...
                  if( get_theme_mod( 'jf_twitter_handle' ) ) {
                    ?>
                    <li>
                      <a href="https://twitter.com/<?php echo get_theme_mod( 'jf_twitter_handle' ); ?>" class="si-twitter">
                  ...
                  if( get_theme_mod( 'jf_instagram_handle' ) ) {
                    ?>
                    <li>
                      <a href="https://www.instagram.com/<?php echo get_theme_mod( 'jf_instagram_handle' ); ?>" class="si-instagram">
        ...
        <div class="top-advert">
          <?php 
            if ( function_exists('quads_ad') ) {
              echo quads_ad( ['location' => 'jf_top_header'] );
            }
         ?> 
      ...
      <div id="header-wrap">
        ...
        <nav id="primary-menu" class="style-2">
          ...
          <div class="container clearfix">
			...
			if( get_theme_mod( 'jf_header_show_cart' ) ) { 
              ...
              <!-- <img src="images/shop/small/6.jpg" /> -->
				...
				if( get_theme_mod( 'jf_header_show_search' ) ) {
					?>
					<!-- Top Search
					============================================= -->
					<div id="top-search">
						...
						<form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get">
							<input 
								...
								name="s" 
								class="form-control" 
								placeholder="<?php _e('Type &amp; Hit Enter..', 'jf' ); ?>" 
